...
/** Metadata key holding the scopes a handler requires. */
export const REQUIRED_SCOPES = 'requiredScopes';

/**
 * The scope that grants administrative access. An admin is simply a user that
 * owns this scope — there is no `isAdmin` flag or role table.
 */
