...
/**
 * Standalone entry — full Admin nested routes under basename `/`.
 * Hosted shell uses `expose.tsx` (no SessionGate) with basePath `/app/admin`.
 */
...
function StandaloneRoot() {
  ...
  return (
    <ThemeProvider theme={createTheme(mode)}>
      ...
      >
        <AdminApp basePath="/" routeName="admin" />
      </SessionGate>
    </ThemeProvider>
  );
}
